...
#lst_probabilities = np.loadtxt('data_test_sampled/101_classifiers_probabilities_global_AVG.txt')
#y_global_test = np.loadtxt("data_test_sampled/y_global_test_AVG.txt")
...
x_global_train = np.loadtxt("data_test_sampled/x_global_train_AVG.txt")
y_global_train = np.loadtxt("data_test_sampled/y_global_train_AVG.txt")
x_global_test = np.loadtxt("data_test_sampled/x_global_test_AVG.txt")
y_global_test = np.loadtxt("data_test_sampled/y_global_test_AVG.txt")
...
#np.savetxt('data_test_sampled/101_classifiers_predictions_global_AVG.txt', lst_predictions)
np.savetxt('data_test_sampled/101_classifiers_probabilities_trained_local_tested_global_AVG.txt', lst_probabilities)
