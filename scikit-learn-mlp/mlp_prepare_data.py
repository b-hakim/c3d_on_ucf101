...
def make_experiments(num_hidden_layers, _feature_layer, solver, force_replace):
    ...
    if force_replace or not os.path.isfile(filename) or not os.path.isfile("data_test_sampled/y_"+feature_layer+".txt"):
        ...
        np.savetxt("data_test_sampled/x_"+feature_layer+".txt", x) # the save is trained on sample of testing
        np.savetxt("data_test_sampled/y_"+feature_layer+".txt", y)

        np.savetxt("data_test_sampled/x_local_train_"+feature_layer+".txt", x_train) # the save is trained on sample of testing
        np.savetxt("data_test_sampled/y_local_train_"+feature_layer+".txt", y_train)
        np.savetxt("data_test_sampled/x_local_test_"+feature_layer+".txt", x_test) # the save is trained on sample of testing
        np.savetxt("data_test_sampled/y_local_test_"+feature_layer+".txt", y_test)
        ...
        x_train = np.loadtxt("data_test_sampled/x_local_train_" + feature_layer + ".txt")
        x_test = np.loadtxt("data_test_sampled/x_local_test_" + feature_layer + ".txt")
        y_test = np.loadtxt("data_test_sampled/y_local_test_" + feature_layer + ".txt")
